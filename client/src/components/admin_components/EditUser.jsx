...
export const EditUser = () => {
    ...
    const [userDetails, setUserDetails] = useState({ doorNo: "", fName: "", phoneNo: "", email: "" });
    const [activeField, setActiveField] = useState({ doorNo: false, fName: false, phoneNo: false, email: false });
    const inputs = useRef({ doorNo: null, fName: null, phoneNo: null, email: null });
    const [isOtpReseaved, setIsOtpReseaved] = useState(true);
    const fields = [
        { label: "Door No", name: "doorNo", type: "text" },
        { label: "New Name", name: "fName", type: "text" },
        { label: "New Phone No", name: "phoneNo", type: "number" },
        { label: "New E-mail", name: "email", type: "email" },
    ...
    const handleEditUser = async (e) => {
        ...
        try {
            ...
            const response = await AxiosConfig().post(`/admin/edit-user`, { userDetails });
            if (response.data.otpSent) {
                toast.success(response.data.message);
                navigate("/verifyotp", { state: { auth: "edit-user", userDetails } });
                ...
                <div className="d-flex justify-content-center align-items-center vh-100">
                    <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
                        <div className={theme ? styles.containerLight : styles.containerDark}>
                            <h1 className="text-center text-primary my-3">Edit User</h1>
